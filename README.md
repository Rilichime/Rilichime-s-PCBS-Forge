...
PCBS-Forge is a Python program built to be used during your PCBS playthroughs. It was made in Windsurf using Cognition's SWE-1.5 model. 
...
**UI**
- **Dark theme with larger text options**, featuring easy-to-read fonts and four adjustable font sizes for accessibility  
- **Quick copy for part names** — double-click to copy full names and paste in-game with Ctrl + V  
...
3. Double-click suggestions in the list to add parts
...
4. Click **"Add to Build"** on parts you want to add
...
4. Used parts are removed from inventory and the build/job is deleted
